...
describe('ClaimAuthService', () => {
  ...
  it('should generate EIP-712 signature with correct format', async () => {
    ...
    const _mockPublisher = testWallet.address
  ...
  it('should validate signature format matches smart contract requirements', async () => {
    const _poolAddress = '0x1111111111111111111111111111111111111111'
    const _farmerAddress = '0x2222222222222222222222222222222222222222'
    const _cumulativeAmount = 100
