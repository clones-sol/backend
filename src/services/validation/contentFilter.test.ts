...
describe('ContentFilterService', () => {
  describe('isReferralCodeAcceptable', () => {
    it('should accept valid referral codes', async () => {
      const validCodes = ['ABCDEF', 'XYZ789', 'HEJJO2', 'WORJD9', 'GAME42', 'SUPER7']
    ...
    it('should reject blacklisted codes', async () => {
      const blacklistedCodes = ['FVCK23', 'SHGT23', 'NAZG23', 'ADMYN2', 'SYSTEM', 'TEST23']
  ...
  describe('blacklist management', () => {
    ...
    it('should handle case-insensitive blacklist operations', async () => {
      ...
      expect(await ContentFilterService.isReferralCodeAcceptable(testCode.toUpperCase())).toBe(
        false
      )
