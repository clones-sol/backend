...
describe('ReferralService', () => {
  ...
  let _testExpiredCode: Document & IReferralCode
  ...
  beforeEach(async () => {
    ...
    _testExpiredCode = await ReferralCodeModel.create({
  ...
  describe('generateReferralCode', () => {
    ...
    it('should generate a new unique referral code for new wallet', async () => {
      ...
      const codeInDb = await ReferralCodeModel.findOne({
    ...
    it('should throw error if unable to generate unique code after max attempts', async () => {
      ...
      const _originalMethod = testService.generateReferralCode.bind(testService)
      testService.generateReferralCode = vi
        .fn()
        .mockRejectedValue(new Error('Failed to generate unique referral code after 100 attempts'))
  ...
  describe('Race condition prevention', () => {
    it('should prevent race conditions when creating multiple referrals concurrently', async () => {
      const p1 = referralService.createReferral(
        TEST_WALLETS.referrer,
        '0x976EA74026E726554dB657fA54763abd0C3a0aa9',
        'TESTCD'
      )
      const p2 = referralService.createReferral(
        TEST_WALLETS.referrer,
