    ...
    describe('cleanupOldReferrals', () => {
            ...
            const oldReferrals = [
                {
                    ...
                    referralCode: 'OLD1',
                    referralLink: 'https://clones.sol/ref/OLD1',
                ...
                },
                {
                    ...
                    referralCode: 'OLD2',
                    referralLink: 'https://clones.sol/ref/OLD2',
                    firstActionType: 'wallet_connect',
        ...
        it('should not delete recent referrals', async () => {
            ...
            await ReferralModel.create({
                ...
                referreeAddress: 'referree1',
                referralCode: 'RECENT',
                referralLink: 'https://clones.sol/ref/RECENT',
                firstActionType: 'wallet_connect',
                firstActionData: { connectionToken: 'token1' },
                status: 'confirmed',
            ...
            const referrals = [
                {
                    ...
                    referralLink: 'https://clones.sol/ref/CONFIRMED',
                    firstActionType: 'wallet_connect',
                    firstActionData: { connectionToken: 'token1' },
                    status: 'confirmed',
                ...
                },
                {
                    ...
                    referralLink: 'https://clones.sol/ref/PENDING',
                    firstActionType: 'wallet_connect',
                    firstActionData: { connectionToken: 'token2' },
                    status: 'pending',
                    createdAt: new Date(Date.now() - 400 * 24 * 60 * 60 * 1000)
